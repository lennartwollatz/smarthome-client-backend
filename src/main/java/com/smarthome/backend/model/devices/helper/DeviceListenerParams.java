...
public class DeviceListenerParams {
    ...
    public DeviceListenerParams(String name) {
        this.name = name;
    }
    
    public DeviceListenerParams(String name, Object param1) {
        this.name = name;
        this.param1 = param1;
    }
    
    public DeviceListenerParams(String name, Object param1, Object param2) {
        this.name = name;
        this.param1 = param1;
        this.param2 = param2;
    }

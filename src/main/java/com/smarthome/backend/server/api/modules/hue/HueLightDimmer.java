...
/**
 * Repräsentiert ein Hue Light mit Dimmfunktion als Gerät.
 * Erweitert {@link DeviceLightDimmer} und implementiert die Hue-spezifische Kommunikation.
 *
 * Analog zu {@link HueLight}, {@link HueLightLevelSensor}, {@link HueMotionSensor}
 * und {@link HueTemperatureSensor}.
 */
public class HueLightDimmer extends DeviceLightDimmer {

    private static final Logger logger = LoggerFactory.getLogger(HueLightDimmer.class);
    ...
    /**
     * Erstellt ein neues HueLightDimmer-Device.
     *
     ...
     */
    public HueLightDimmer(String name, String id, String bridgeId, String hueResourceId, String batteryRid) {
        super(name, id);
    ...
    /**
     * Initialisiert die initialen Werte der Lampe (Dimmwert etc.).
     * Aktuell werden keine Werte aktiv von der Hue API gelesen.
     * Diese Methode kann in Zukunft erweitert werden (z. B. Abruf des aktuellen Dimm-/On-Status).
     */
    @Override
    ...
    protected void executeSetOn() {
        logger.info("executeSetOn: {}", getId());
        if (hueDeviceController == null) {

...
/**
 * Repräsentiert ein Hue Light mit Dimm- und Farb-Funktion als Gerät.
 * Erweitert {@link DeviceLightDimmerTemperatureColor} und implementiert die Hue-spezifische Kommunikation.
 *
 * Analog zu {@link HueLightDimmer}, {@link HueLight}, {@link HueLightLevelSensor},
 * {@link HueMotionSensor} und {@link HueTemperatureSensor}.
 */
public class HueLightDimmerTemperatureColor extends DeviceLightDimmerTemperatureColor {

    private static final Logger logger = LoggerFactory.getLogger(HueLightDimmerTemperatureColor.class);
     ...
     */
    public HueLightDimmerTemperatureColor() {
        super();
        this.bridgeId = null;
    ...
    /**
     * Erstellt ein neues HueLightDimmerTemperatureColor-Device.
     *
     ...
     */
    public HueLightDimmerTemperatureColor(String name, String id, String bridgeId, String hueResourceId, String batteryRid) {
        super(name, id);
    ...
    /**
     * Initialisiert die initialen Werte der Lampe (Dimmwert, Farbe etc.).
     * Aktuell werden keine Werte aktiv von der Hue API gelesen.
     * Diese Methode kann in Zukunft erweitert werden (z. B. Abruf des aktuellen Dimm-/Farb-/On-Status).
     */
    @Override
    public void updateValues() {
        ...
        hueDeviceController.fetchSingleResource(this.bridgeId, "light", this.hueResourceId).thenAccept(v -> {
            ...
            this.color.setX(v.get("color").getAsJsonObject().get("xy").getAsJsonObject().get("x").getAsDouble());
            this.color.setY(v.get("color").getAsJsonObject().get("xy").getAsJsonObject().get("y").getAsDouble());

import { TimeTrigger } from "../action/TimeTrigger.js";
import { ActionRunnable } from "./ActionRunnable.js";
import { ActionRunnableResponse } from "./ActionRunnableResponse.js";

export type ActionRunnableTimeBasedRunnable = () => Promise<ActionRunnableResponse>;

export class ActionRunnableTimeBased extends ActionRunnable {
  private runnable: ActionRunnableTimeBasedRunnable;
  private timeTrigger: TimeTrigger;
  private stopped = false;
  private timeoutId: NodeJS.Timeout | null = null;

  constructor(id: string, runnable: ActionRunnableTimeBasedRunnable, timeTrigger: TimeTrigger) {
    super(id, id, "time");

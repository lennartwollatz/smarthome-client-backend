...
export class EventCarClimateControlChanged extends Event{
    constructor(deviceId: string, carBefore: object, climateControlStateAfter: boolean, eventId: string = crypto.randomUUID()) {

...
export class EventCalendarEntryChangedName extends Event{
    constructor(deviceId: string, entryBefore: DeviceCalendarEntry, newName: string, eventId: string = crypto.randomUUID()) {

...
export class EventCarFuelLevelEquals extends Event{
    constructor(deviceId: string, carBefore: object, fuelLevelPercent: number, eventId: string = crypto.randomUUID()) {
        ...
        super(eventId, deviceId, Date.now(), EventType.CAR_FUEL_LEVEL_EQUALS, [eventCondition], [], [resultCondition], false);
    }
